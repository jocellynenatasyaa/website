<?php
    ...
    // {
    //     echo "<script>alert('You must to Login!')</script>";
...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            ...
            <div style="color: white;padding: 15px 50px 5px 50px;float: right;font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="../login.php"
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="index.php?halaman=pembelian"><i class="fa fa-dashboard fa-3x"></i> Transaction</a>
                    </li>
                    <li>
                        <a href="index.php?halaman=pelanggan"><i class="fa fa-dashboard fa-3x"></i> Customer</a>
                    </li>
                    <li>
                        <a href="../login.php"><i class="fa fa-dashboard fa-3x"></i> Logout</a>
                    </li>
                </ul>
